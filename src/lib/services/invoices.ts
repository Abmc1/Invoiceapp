...
export interface CreateInvoiceInput {
  ...
  notes?: string | null;
  items: LineItemDraft[];
  /** Null only for invoices auto-generated by a recurring schedule whose own creator is unset — every human-initiated call passes a real user id. */
  createdByUserId: string | null;
  vatExempt?: boolean;
  vatExemptReason?: string | null;
  /** Set when this invoice is being auto-generated by a recurring schedule's sweep, rather than created by hand. */
  ...
  return db.transaction(async (tx) => {
    ...
    const [invoice] = await tx
      ...
      .values({
        ...
        sourceRecurringInvoiceId: input.sourceRecurringInvoiceId ?? null,
      })
      .returning();
